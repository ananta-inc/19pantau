...
function selectGraph() {
  selectMode = document.getElementById("selectGraph").value;
  if (selectMode == 1) {
    removeFirst()
    bpm()
...
// function removeTr() {
//     var ids = document.querySelectorAll("#svg_dataviz"), // Get a collection of cells with same ids
//         len = ids.length,
//         n;
...
function removeFirst() {
  if (document.contains(document.getElementById("svg_dataviz"))) {
    document.getElementById("svg_dataviz").remove();
  }
}
